...
class GroupTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table( 'groups' ) -> insert([
            ...
            "web_icon"          =>  '<svg class="h-5 w-5 mx-auto mb-1" fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,20.75a.75.75,0,1,0,.75.75.749.749,0,0,0-.75-.75Z"/><rect class="a" x="5.5" y="0.5" width="13" height="23" rx="2" ry="2"/></svg>',
