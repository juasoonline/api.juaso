...
class StoreObserver
{
    ...
    public function created( Store $store )
    {
        ...
        DB::table( 'charges' ) -> insert(['resource_id' =>  uniqid(), 'store_id' => $store -> id, 'name' => 'Per Sale', 'fee' => 0.05, 'description' =>  '5 percent of the product sales price will be charged for each sales of the product.', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
    }
}
